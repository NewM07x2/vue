<template>
  <div id='main-top'>
    <div id='header-img' class='page-header header-filter header-small'>
      <div class='container'>
        <div class='row'>
    ...
    <div class='main main-raised'>
      <div class='container'>
        <div class='section'>
          ...
          <div class='row'>
            <div class='col-md-6'>
              <div class='card card-raised card-background' style='background-image: url("#")'>
                <div class='card-body'>
          ...
          <div class='row'>
            <div class='col-md-4'>
              <div class='card card-plain card-blog'>
                <div class='card-header card-header-image height250'>
                  <a href='#'>
                    <img class='img img-raised' src="#">
                  </a>
                  <div class='colored-shadow' style='background-image: url(&quot;#&quot;); opacity: 1;'></div>
                </div>
                <div class='card-body'>
                  ...
                  <p class='card-description'>
                    Like so many organizations these days, Autodesk is a company in transition. It was until recently a traditional boxed software company selling licenses.<a href='#'> Read More </a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class='row'>
            <div class='col-md-6'>
              <div class='card card-profile card-plain'>
                <div class='row'>
                  <div class='col-md-5'>
                    <div class='card-header card-header-image height100_ width100_'>
                      <a href='#'>
                        <img class='img' src="#">
                      </a>
                      <div class='ripple-container'></div>
